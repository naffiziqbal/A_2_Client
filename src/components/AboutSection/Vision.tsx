...
const Vision = () => {
  return (
    <div className="bg-gradient-to-tr from-orange-600 to-red-600 p-3">
      <div className="flex md:flex-row flex-col  lg:container mx-auto  md:justify-center items-center text-[#e2e2e2] gap-5 relative">
